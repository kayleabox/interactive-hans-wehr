...
fs.writeFileSync('src/newTextVersion/parsedFiles/allArabicWords.txt', allArabicWordsArray.join('\n'), 'utf-8');
fs.writeFileSync('src/newTextVersion/parsedFiles/arabicWordsDict.json', JSON.stringify(arabicWordCountDict), 'utf-8');
